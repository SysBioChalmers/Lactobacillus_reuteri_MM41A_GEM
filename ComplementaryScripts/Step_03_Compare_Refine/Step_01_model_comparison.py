...
if  __name__ == '__main__':
    ...
    #Lreu_ca_standardlized,ca_report = model_report_compare_bigg(Lreu_ca, bigg_rea_df, bigg_met_df, compartment='_')
    #Lreu_ca_gp_standardlized, ca_gp_report = model_report_compare_bigg(Lreu_ca_gp, bigg_rea_df, bigg_met_df, compartment='_')

    #cobra.io.save_json_model(Lreu_ca_standardlized,'CarveMe/Lreu_ca_standardlized.json')
    #cobra.io.save_json_model(Lreu_ca_gp_standardlized, 'CarveMe/Lreu_ca_gp_standardlized.json')
    Lreu_ca_standardlized = cobra.io.load_json_model('CarveMe/Lreu_ca_standardlized.json.json')
    Lreu_ca_gp_standardlized = cobra.io.load_json_model('CarveMe/Lreu_ca_gp_standardlized.json.json')
    Lreu_from_iNF517 = cobra.io.load_json_model('Template/Lreu_from_iNF517.json')
    Lreu_from_iBT721 = cobra.io.load_json_model('Template/Lreu_from_iBT721.json')
    ...
    Lreu_ca_genes = [i.id for i in Lreu_ca_standardlized.genes]
    Lreu_ca_gp_genes = [i.id for i in Lreu_ca_gp_standardlized.genes]
    Lreu_ca_reas = [i.id for i in Lreu_ca_standardlized.reactions]
    Lreu_ca_gp_reas = [i.id for i in Lreu_ca_gp_standardlized.reactions]
    Lreu_ca_mets = [i.id for i in Lreu_ca_standardlized.metabolites]
    Lreu_ca_gp_mets = [i.id for i in Lreu_ca_gp_standardlized.metabolites]
    ...
    fg1 = My_def.venn3_samesize([set(Lreu_from_iBT721_genes),
                 set(Lreu_from_iNF517_genes),
                 set(Lreu_ca_gp_genes)],
                ('iBT721', 'iNF517','CarveMe'), ax=axes[0])

    fg2 = My_def.venn3_samesize([set(Lreu_from_iBT721_reas),
                 set(Lreu_from_iNF517_reas),
                 set(Lreu_ca_gp_reas)],
                ('iBT721', 'iNF517','CarveMe'), ax=axes[1])

    fg3 = My_def.venn3_samesize([set(Lreu_from_iBT721_mets),
